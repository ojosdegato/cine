...
public class Main {
	...
	public static void main(String[] args) {
		...
		Pelicula pelicula3 = new Pelicula("Gladiador", "Acción", 150, 18,
		...
		Pelicula pelicula5 = new Pelicula("El origen", "Ciencia Ficción", 148, 16,
		...
		Pelicula pelicula7 = new Pelicula("El caballero oscuro", "Acción", 152, 16,
		...
		Pelicula pelicula9 = new Pelicula("El rey león", "Animación", 88, 0,
				"Un joven león aprende a enfrentar su destino", "https://youtube.com/ver_trailer9");

		Pelicula pelicula10 = new Pelicula("Vengadores: Endgame", "Acción", 181, 12,
